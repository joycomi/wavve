...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="VideoId" v-model="value.videoId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            VideoId :  {{value.videoId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="VideoTitle" v-model="value.videoTitle"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="RentPrice" v-model="value.rentPrice"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="MemId" v-model="value.memId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            MemId :  {{value.memId }}
          </div>
